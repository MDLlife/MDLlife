...
function mob_video(){
    if(window.screen.width < 768 || window.innerWidth < 768 || window.screen.availWidth < 768){
        $('#video-preview').attr('poster','/app/assets/img/website-parts/about/video-preview-mob.png')
    }
}
...
function mentorsPopup(){
    $('.mentor__item').click(function(){
        ...
        var linked_template = '<a href="'+path+'" class="modal--linkin" ><img src="/app/assets/img/linkedin-logo.svg" alt=""></a>';
        $('#mentorsModal .modal-body').html($(this).find('.mentor__item--desc').html());
        if( path.length > 2){
